class ProvenanceRecordsController < ApplicationController
  ...
  private
    ...
    def provenance_record_params
      params.require(:provenance_record).permit(:accession_number, :collection_name, :start_year, :end_year, :date_expression, :year_received, :month_received, :day_received, :linear_feet, :containers)
    end
end
